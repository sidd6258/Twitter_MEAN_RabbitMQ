mytwitter.controller("FollowerslistController", function($scope,$http,$location,$window){
	
$scope.loadfollowers=function(){
	
	 console.log($window.sessionStorage.userid);
	       $http({
		         url: '/loadfollowerscontent', 
		         method: 'GET'
		        	 ...
		        	 tc.innerHTML=data.followers.length;
		        	 for(i=0;i<data.followers.length;i++)
		        		 ...
		        		 str.innerHTML=data.followers[i].first_name;
		        		 ...
		        		 b.innerHTML=data.followers[i].handle;
